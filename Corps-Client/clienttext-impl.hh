...
{
public:
  ClientText_Impl(Client_Impl &parent) throw();
  ...
  virtual void request_string (const char *what, char *&str) throw(RolePlaying::WrongCookie);
  virtual void request_text (const char *what, char *&text) throw(RolePlaying::WrongCookie);
